...
Identify the bird with the fewest neck vertebrae

Compare number of bones in human arms vs legs

Calculate number of human ribs

Challenges Solved

Merging datasets with different schemas

Converting row-based data into aggregated counts
